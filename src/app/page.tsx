    ...
    <>
      ...
      <nav className="nav">
        ...
        <div className="nav-links">
          ...
          <a href="https://apps.apple.com/in/app/awekn-lifting-gym-log-diet/id6762414034" target="_blank" rel="noopener noreferrer" className="nav-cta">Get the app</a>
        </div>
      </nav>
      ...
      <section className="hero">
        <div className="hero-left">
          ...
          <div className="hero-buttons">
            <a href="https://apps.apple.com/in/app/awekn-lifting-gym-log-diet/id6762414034" target="_blank" rel="noopener noreferrer" className="btn-primary">
            ...
            {/* Android: inert until the Play Store listing is live. Add href="<play-store-url>" target="_blank" rel="noopener noreferrer" when ready. */}
            <a className="btn-ghost" role="button" aria-disabled="true" style={{ cursor: 'default' }}>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
