    ...
    <div className="legal-page">
      ...
      <div className="legal-container">
        ...
        <div className="legal-content">
          ...
          <p><strong>Camera and photo library.</strong> awekn uses your device camera when you tap &ldquo;Take a photo&rdquo; to capture a progress photo, a workout selfie, a custom share-card background, a community post photo, or an avatar. awekn reads from your photo library when you tap &ldquo;Choose from library&rdquo; to pick one of those images. awekn writes to your photo library only when you tap &ldquo;Save&rdquo; on a finished share card. We never scan, enumerate, or upload photos you do not explicitly select.</p>
          ...
          <p><strong>Community and public profile data (optional).</strong> If you use the community features, we process the content you choose to publish (workout snapshots, photos, captions, text posts, comments, reactions), your follow graph (who you follow and who follows you, including pending requests), likes, direct messages, blocks, mutes, reports you file, and your community preferences (private account, discoverable, who can message you, message previews, routines on profile). Shared content is visible to the audience you chose for each post; your public profile (username, display name, avatar, bio, follower and following counts, shared-workout count, and the names of your current programs unless you turn that off) is visible to any signed-in awekn user who is not blocked. Nothing is published automatically.</p>
          <p><strong>Community photos.</strong> Photos you attach to a post are resized, re-encoded, and stripped of EXIF metadata (including GPS location) on your device before upload, then stored in Supabase Storage. Photos attached to posts shared with &ldquo;everyone&rdquo; are served from a public content-delivery URL that is not guessable but can be opened by anyone who has the link; photos attached to followers-only or only-me posts are stored in a private bucket and served only through short-lived signed links to people allowed to see the post. Avatars are public.</p>
          <p><strong>Automated content moderation.</strong> When you publish or edit a post, comment, bio, display name, or avatar, its text and images may be sent to an automated moderation service (OpenAI&rsquo;s moderation endpoint) that returns only a set of category flags; the content is not used to train models. Flagged content is removed and an internal report is filed for human review. We also review user reports within 24 hours.</p>
          ...
          <div style={{ overflowX: 'auto' }}>
            <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: '1.5em' }}>
              ...
              <tbody>
                ...
                <tr><td style={{ padding: '8px 6px', verticalAlign: 'top' }}><strong>OpenAI</strong> (automated content moderation for community posts, comments, and profiles)</td><td style={{ padding: '8px 6px', verticalAlign: 'top' }}>Text and images you publish to the community, at the moment of publishing or editing (image links carry a pseudonymous storage path that includes your account id; no name or email)</td><td style={{ padding: '8px 6px', verticalAlign: 'top' }}>United States</td><td style={{ padding: '8px 6px', verticalAlign: 'top' }}>Standard Contractual Clauses (<a href="https://openai.com/policies/data-processing-addendum" target="_blank" rel="noopener noreferrer">DPA</a>); zero data retention for moderation inputs per OpenAI&rsquo;s API policy</td></tr>
                <tr><td style={{ padding: '8px 6px', verticalAlign: 'top' }}><strong>Expo</strong> (push notification delivery)</td><td style={{ padding: '8px 6px', verticalAlign: 'top' }}>Your push token and the title and body of each notification we send you, which for a direct message may include a preview of the message text unless you disable previews</td><td style={{ padding: '8px 6px', verticalAlign: 'top' }}>United States</td><td style={{ padding: '8px 6px', verticalAlign: 'top' }}>Standard Contractual Clauses (<a href="https://expo.dev/dpa" target="_blank" rel="noopener noreferrer">DPA</a>); relayed onward to Apple APNs or Google FCM for delivery</td></tr>
          ...
          <p><strong>Community data.</strong> Deleting your account also removes your posts, photos (from both storage buckets), comments, reactions, follow relationships in both directions, direct message threads with anyone, blocks, mutes, and notifications sent to or by you. Routines that other users copied before you deleted your account remain in their accounts as their own data. Reports you filed are kept without your identity or free text (only the reported item and reason) as a moderation audit trail, and every report is deleted after two years.</p>
          ...
          <p><strong>Consent log.</strong> The record of consents you have granted under Article 9(2)(a) GDPR (Section 3 above), including timestamps and policy versions, is retained for the lifetime of your account and is deleted together with your account. The record contains only your user identifier and the consent metadata; it does not contain the health data itself.</p>
          ...
          <h2>10. Children</h2>
          <p>awekn is not directed at children under 13. We do not knowingly collect personal data from children under 13. If you believe a child under 13 has provided us data, please contact us and we will delete it. The community features (public profiles, sharing, messaging) require users to confirm they are at least 16; younger users can use the rest of the app without a public presence.</p>
